<p align="center">
<img src="./docs/docs/public/luma.svg" style="width:100px;" />
...
Add `Luma UI` to your project by running one of the following commands:
...
**By doing this, you are importing all the components that are provided by Luma UI and in your final bundle all the components including the ones you didn't use will be bundled. Use method of component registration if you are confident that you will use all the components.**
