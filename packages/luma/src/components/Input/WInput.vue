...
const props = defineProps({
  ...
  loadingIcon: {
    type: String,
    default: () => lumaTheme.WInput.base.inputLoadingIcon,
  },
  leadingIcon: {
    type: String,
    default: null,
  ...
  size: {
    ...
    validator(value: string) {
      return Object.keys(lumaTheme.WInput.base.inputSize).includes(value);
    },
  },
});
...
const inputLabelTextSize = computed(() => {
  return classNames(
    ...
    lumaTheme.WInput.base.inputSize &&
      lumaTheme.WInput.base.inputSize[props.size],
  );
});

const inputWrapperClass = computed(() => {
  return classNames(
    lumaTheme.WInput.base.inputRounded[props.rounded],
    variant.value.inputWrapper,
    variant.value.inputPlaceholder,
    lumaTheme.WInput.base.inputSize &&
      lumaTheme.WInput.base.inputSize[props.size],
    props.padded
      ? lumaTheme.WInput.base.inputPadding &&
          lumaTheme.WInput.base.inputPadding[props.size]
      : "!p-0",
    (isLeading.value || slots.leading) &&
      lumaTheme.WInput.base.inputLeadingPadding &&
      lumaTheme.WInput.base.inputLeadingPadding[props.size],
    (isTrailing.value || slots.trailing) &&
      lumaTheme.WInput.base.inputTrailingPadding &&
      lumaTheme.WInput.base.inputTrailingPadding[props.size],
  );
});
...
const leadingIconClass = computed(() => {
  return classNames(
    ...
    lumaTheme.WInput.base.inputIconSize &&
      lumaTheme.WInput.base.inputIconSize[props.size],
...
const iconLeadingWrapperClass = computed(() => {
  return classNames(
    ...
    lumaTheme.WInput.base.inputIconLeadingPadding &&
      lumaTheme.WInput.base.inputIconLeadingPadding[props.size],
  );
});
...
const iconTrailingWrapperClass = computed(() => {
  return classNames(
    ...
    lumaTheme.WInput.base.inputIconTrailingPadding &&
      lumaTheme.WInput.base.inputIconTrailingPadding[props.size],
  );
});
...
<template>
  <div>
    <div :class="variant.inputRequiredDisplay">
      <span v-if="props.label" :class="inputLabelTextSize">{{
        props.label
      }}</span>
    ...
    <div :class="variant.root">
      ...
      <span
        ...
        :class="iconTrailingWrapperClass"
      >
