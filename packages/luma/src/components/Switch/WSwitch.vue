...
<template>
  ...
  >
    <span
      :class="[
        toggle
          ? variant.switchContainerActive
          : variant.switchContainerInActive,
    ...
    >
      <span
        v-if="props.onIcon"
        :class="[
          toggle ? variant.switchIconActive : variant.switchIconInActive,
          variant.switchIcon,
        ]"
        aria-hidden="true"
      >
      ...
      <span
        v-if="props.offIcon"
        :class="[
          toggle ? variant.switchIconInActive : variant.switchIconActive,
          variant.switchIcon,
        ]"
        aria-hidden="true"
      >
