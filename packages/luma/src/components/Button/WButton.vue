...
const props = defineProps({
  ...
  loadingIcon: {
    type: String,
    default: lumaTheme.WButton.base.buttonLoadingIcon,
  },
...
const buttonWrapperClass = computed(() => {
  return classNames(
    ...
    lumaTheme.WButton.base.buttonSize[props.size],
    lumaTheme.WButton.base.buttonGap[props.size],
    lumaTheme.WButton.base.buttonPadding[props.size],
    buttonBlock.value,
