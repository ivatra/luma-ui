export default {
  ...
  WAccordionItem: {
    base: {
      ...
      accordionItemActiveTrailingIconColor:
      ...
      accordionItemIcon:
        "relative ml-auto dark:text-white h-5 w-5 text-black transition-transform duration-500 md:h-6 md:w-6",
      accordionItemIconIsDisabled: "dark:text-gray-800 text-gray-300",
      accordionItemButton:
        "flex justify-between items-center cursor-pointer p-2",
      accordionItemIconIsLeading: "space-x-2.5",
      accordionItemIconIsNotLeading: "space-x-2",
      accordionItemLeadingClass:
        "absolute left-2.5 cursor-pointer flex items-center overflow-hidden",
      accordionItemTrailingClass:
        "absolute right-4 inset-y-0 cursor-pointer flex items-center overflow-hidden",
      accordionItembody:
        "overflow-hidden px-5 transition-[height] duration-500 text-black will-change-[height] md:px-6",
      accordionItemContent:
        "py-2 font-light leading-relaxed tracking-wide text-black dark:text-white",
    },
    variants: {
      default: {
  ...
  WAlert: {
    base: {
      ...
      alertCloseButtonClass:
        "p-0.5 rounded-md -m-1 block transition duration-200 ease-in",
    },
    variants: {
      default: {
      ...
      "default-light": {
        ...
        alertCloseButtonClass:
          "hover:text-white py-1 px-1 hover:bg-yellow-900 !active:text-white",
      },
      "default-dashed": {
        root: [
        ...
        alertCloseButtonClass:
          "!active:text-white hover:text-white py-1 px-1 hover:bg-yellow-900",
      },
      "default-outline": {
        root: [
      ...
      "primary-light": {
        ...
        alertCloseButtonClass:
          "hover:text-white py-1 px-1 hover:bg-blue-900 !active:text-white",
      },
      ...
      "primary-outline": {
        ...
        alertCloseButtonClass:
          "!active:text-white hover:text-white py-1 px-1 hover:bg-blue-900",
      },
      ...
      "success-light": {
        ...
        alertCloseButtonClass:
          "!active:text-white hover:text-white py-1 px-1 hover:bg-green-900",
      },
      ...
      warning: {
        ...
        alertCloseButtonClass:
          "text-white hover:text-white py-1 px-1 hover:bg-orange-800",
      },
      "warning-light": {
        root: [
        ...
        alertCloseButtonClass:
          "!active:text-white hover:text-white py-1 px-1 hover:bg-orange-900",
      },
      "warning-outline": {
        root: [
      ...
      danger: {
        ...
        alertCloseButtonClass:
          "text-white hover:text-white py-1 px-1 hover:bg-red-800",
      },
      "danger-light": {
        root: [
        ...
        alertCloseButtonClass:
          "!active:text-white hover:text-white py-1 px-1 hover:bg-red-900",
      },
      "danger-outline": {
        root: [
  ...
  WAvatar: {
    base: {
      ...
      avatarPlaceholderClass:
        "font-medium cursor-pointer text-gray-600 upperCase",
      ...
      avatarChipClass:
        "flex justify-center items-center absolute rounded-full !text-white cursor-pointer text-white dark:text-gray-900",
      avatarChipPosition: {
  ...
  WBadge: {
    base: {
      ...
      default: "relative",
      badgeBody:
        "text-xs text-white rounded-xl px-1.5 border !border-white dark:border-neutral-800 inline-block ",
      badgeChip: "w-3 h-3 !p-0",
      badgeSquare: "!rounded-[5px]",
      badgePosition: {
        "top-left":
          "absolute top-0 left-0 -translate-x-[45%] -translate-y-[45%]",
        "top-right":
  ...
  WButton: {
    base: {
      ...
      buttonLoading:
        "!bg-opacity-50 opacity-40 pointer-events-none !cursor-not-allowed !hover:bg-opacity-50 inline-flex items-center",
      buttonFull: "w-full flex justify-center items-center",
      buttonDisabled:
        "!shadow-none !cursor-not-allowed bg-opacity-40 dark:opacity-40",
  ...
  WInput: {
    base: {
      root: "relative",
      inputWrapper:
        "relative shadow-sm bg-transparent text-gray-900 dark:text-white focus:ring-2 focus:ring-green-500 dark:focus:ring-green-400 block w-full disabled:cursor-not-allowed disabled:opacity-75 focus:outline-none",
      inputRounded: {
        sm: "rounded-sm",
        md: "rounded-md",
        lg: "rounded-lg",
      ...
      inputIconTrailing:
        "absolute inset-y-0 end-0 flex items-center cursor-pointer",
    ...
    variants: {
      default: {
        root: "relative",
        inputWrapper:
          "relative shadow-sm bg-transparent text-gray-900 dark:text-white ring-1 ring-inset ring-gray-300 dark:ring-gray-800 focus:ring-2 focus:ring-green-500 dark:focus:ring-green-400 block w-full disabled:cursor-not-allowed disabled:opacity-75 focus:outline-none rounded-md",
        inputPlaceholder: "placeholder-gray-400 dark:placeholder-gray-500",
  ...
  WModal: {
    base: {
      ...
      modalPadding: "p-4",
      modalBase:
        "relative text-left rtl:text-right overflow-hidden sm:my-8 w-full flex flex-col",
      ...
      modalOverlayBackground:
        "bg-gray-200/75 dark:bg-[#09090B] dark:bg-opacity-90",
      ...
      variants: {
        default: {
          modalBackground:
            "bg-white border dark:border-gray-600/40 dark:bg-black",
        },
      },
    },
  },
  ...
  WSwitch: {
    base: {
      ...
      switchContainer:
        "pointer-events-none relative inline-block h-4 w-4 rounded-full bg-white dark:bg-gray-900 shadow transform ring-0 transition ease-in-out duration-200",
  ...
  WTag: {
    ...
    variants: {
      ...
      "default-outline": {
        root: ["border border-yellow-500 text-yellow-500 duration-200 ease-in"],
      },
      primary: {
        root: "bg-blue-500 text-white",
      },
      ...
      "primary-outline": {
        root: ["border border-blue-500 text-blue-500 duration-200 ease-in"],
      },
      ...
      "success-outline": {
        root: ["border border-green-500 text-green-500 duration-200 ease-in"],
      },
      ...
      "warning-outline": {
        root: ["border border-orange-500 text-orange-500 duration-200 ease-in"],
      },
      "warning-dashed": {
        root: [
      ...
      "danger-outline": {
        root: ["border border-red-500 text-red-500 duration-200 ease-in"],
      },
      "danger-dashed": {
        root: [
