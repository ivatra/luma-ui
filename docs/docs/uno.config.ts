  ...
  shortcuts: [
    {
      ...
      "o-overview_card_wrapper":
        "flex flex-col  items-center space-x-3 p-4 rounded border border-light-500 hover:bg-#F2F2F2 hover:-translate-y-2 !duration-400 dark:border-#4C4D4F dark:hover:bg-dark-300 !hover-b-emerald-300 !transition-all",
